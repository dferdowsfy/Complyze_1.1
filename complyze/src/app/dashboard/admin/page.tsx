    ...
    <div className="min-h-screen bg-[#0E1E36]">
      ...
      <nav className="flex flex-col sm:flex-row items-center justify-between py-4 sm:py-6 lg:py-8 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto gap-4 sm:gap-6">
        ...
        <div className="flex items-center gap-3 min-w-fit">
          <div className="w-8 h-8 sm:w-10 sm:h-10 lg:w-12 lg:h-12 bg-[#FF6F3C] rounded-lg flex items-center justify-center">
            <span className="text-white font-bold text-sm sm:text-base lg:text-lg">C</span>
          </div>
          <span className="text-white font-bold text-xl sm:text-2xl lg:text-3xl">Complyze</span>
        </div>
